...
#Import Constants
from global_constants import SCREEN_SIZE, NUM_NODES, NODE_RADIUS, CONTROL_MARK_RADIUS, LINE_THICKNESS, FONT_SIZE
...
def initialize_graph():
    ...
    #Get node coordinates and edges pairs based on the selected graph type. Adjust NUM_NODES if it was changed during graph generation
    if approach == "distribution":
        ...
        nodes, edges = gt.random_proxmity()
